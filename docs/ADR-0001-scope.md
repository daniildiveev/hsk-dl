...
- **Операции MVP**: поэлементные (+, -, *, neg), редукции sum/mean, reshape/transpose/permute/slice/select/expand/contiguous, broadcast, matmul/mm, relu/sigmoid/tanh, logSoftmax, crossEntropy.
